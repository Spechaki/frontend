export default function Footer() {
  return (
    <footer className="bg-sky-400 text-white p-6">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
        <div>
          <p>Conectando entrenadores profesionales con clientes que buscan alcanzar sus objetivos fitness de manera personalizada.</p>
        </div>
        <div>
          ...
          <ul className="space-y-1">
            ...
            <li><a href="/register" className="hover:underline">Registrar</a></li>
          </ul>
        </div>
        <div>
