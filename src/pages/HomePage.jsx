      ...
      <div className="bg-sky-400 py-6 px-4">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row md:items-center md:justify-between">
          <div className="mb-4 md:mb-0">
            <h1 className="text-2xl font-bold text-white">ENCUENTRA TU ENTRENADOR PERSONAL</h1>
            ...
            <div className="flex flex-wrap gap-2 mt-4">
              {['Gimnasio', 'Running', 'Nutrición', 'Yoga', 'Crossfit', 'Pilates', 'Musculación', 'Virtual', 'Personal', 'A Domicilio', 'Clásico', 'Funcional', 'HIIT', 'Entrenamiento', 'Más...'].map((cat) => (
                <span key={cat} className="bg-white/80 text-sky-700 px-2 py-1 rounded text-xs font-semibold shadow">{cat}</span>
              ))}
            </div>
          </div>
          <div className="flex gap-4">
            <img alt="Yoga" className="w-40 h-28 object-cover rounded shadow-lg" />
            <img alt="Meditación" className="w-40 h-28 object-cover rounded shadow-lg -ml-8 mt-8" />
          </div>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto grid md:grid-cols-3 gap-6">
          <div className="bg-sky-200 rounded-lg shadow p-4 text-center items-center justify-center flex flex-col">
            <div class="w-16 h-16 rounded-full bg-sky-100 flex items-center justify-center">
                <p class="text-black text-2xl font-bold">1</p>
            </div>
          ...
          <div className="bg-sky-200 rounded-lg shadow p-4 text-center items-center justify-center flex flex-col">
            <div class="w-16 h-16 rounded-full bg-sky-100 flex items-center justify-center">
                <p class="text-black text-2xl font-bold">2</p>
            </div>
          ...
          <div className="bg-sky-200 rounded-lg shadow p-4 text-center items-center justify-center flex flex-col">
            <div class="w-16 h-16 rounded-full bg-sky-100 flex items-center justify-center">
                <p class="text-black text-2xl font-bold">3</p>
            </div>
